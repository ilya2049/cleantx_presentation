...
```go 27:36 file=./src/tx_in_ctx/pgsql/app_decorator.go title="Декоратор команд" subtitle="Команда 'Начать смену'"
```

```go 38:47 file=./src/tx_in_ctx/pgsql/app_decorator.go title="Декоратор команд" subtitle="Команда 'Завершить смену'"
```
