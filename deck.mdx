...
```jsx file=./src/tx_in_repo/app_structure.txt title="Транзакция в репозитории"
```

```jsx 17 file=./src/tx_in_repo/app_structure.txt title="Транзакция в репозитории"
```
...
```jsx 48 file=./src/base/domain/doctor.go title="Транзакция в репозитории" subtitle="Скрываем транзакцию в репозитории"
```

```jsx 48 file=./src/tx_in_repo/domain/doctor.go title="Транзакция в репозитории" subtitle="Скрываем транзакцию в репозитории"
```
...
```jsx 13 file=./src/tx_in_repo/app_structure.txt title="Транзакция в репозитории"
```
...
```jsx 34:54 file=./src/base/app/command_executor.go title="Транзакция в репозитории" subtitle="Убираем команду 'Закончить смену' в репозиторий"
```

```jsx 34:36 file=./src/tx_in_repo/app/command_executor.go title="Транзакция в репозитории" subtitle="Убираем команду 'Закончить смену' в репозиторий"
```
...
```jsx 20 file=./src/tx_in_repo/app_structure.txt title="Транзакция в репозитории"
```
...
```jsx 94:110 file=./src/tx_in_repo/pgsql/doctor_repository.go title="Транзакция в репозитории" subtitle="Открытие/завершение"
```

```jsx 112:131 file=./src/tx_in_repo/pgsql/doctor_repository.go title="Транзакция в репозитории" subtitle="Команда 'Завершить смену'"
```
